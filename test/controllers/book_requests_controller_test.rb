...
class BookRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_request" do
    assert_difference("BookRequest.count") do
      post book_requests_url, params: { book_request: { meeting_place_id_id: @book_request.meeting_place_id_id, meeting_time: @book_request.meeting_time, requested_book_id_id: @book_request.requested_book_id_id, requester_id_id: @book_request.requester_id_id } }
    end
  ...
  test "should update book_request" do
    patch book_request_url(@book_request), params: { book_request: { meeting_place_id_id: @book_request.meeting_place_id_id, meeting_time: @book_request.meeting_time, requested_book_id_id: @book_request.requested_book_id_id, requester_id_id: @book_request.requester_id_id } }
