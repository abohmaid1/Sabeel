...
const RePasswordInput = document.getElementById("user_password_confirmation");
...
const handleFormData = (e) => {
    ...
    if (password != RePassword && passwordInput != "") {
        showError(RePasswordInput, "كلمتا السر غير متطابقتان");
    }
